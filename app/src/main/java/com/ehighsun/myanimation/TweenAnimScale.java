...
public class TweenAnimScale extends AppCompatActivity implements View.OnClickListener {
...
//        loadAnim1();//
    ...
    private void loadAnim1() {
        alphaAnimation = AnimationUtils.loadAnimation(this,R.anim.anim_scale);
